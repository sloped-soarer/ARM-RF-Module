...
#define MPX_MULTIPLIER 7
#if UNIMOD == 1 // mpx serial input source.
#define DELTA_PPM_IN 550L // 500 for Most systems or 550 for Multiplex. e.g. 1500 +/- 550 us
#define CHAN_MAX_VALUE (1520L * MPX_MULTIPLIER)
#elif UNIMOD == 2 // mpx ppm input source.
#define DELTA_PPM_IN 550L
#define CHAN_MAX_VALUE (+DELTA_PPM_IN * 20)
#elif UNIMOD == 3 // standard ppm input source.
#define DELTA_PPM_IN 512L // OpenTX uses +/- 512 uS
#define CHAN_MAX_VALUE (+DELTA_PPM_IN * 20)
#endif // UNIMOD
...
#ifndef UNIMOD
#define DELTA_PPM_IN 500L // 500 for Most systems or 550 for Multiplex. e.g. 1500 +/- 550 us
